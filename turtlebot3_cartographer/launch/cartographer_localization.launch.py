...
def generate_launch_description():
    ...
    turtlebot3_navigation = get_package_share_directory('turtlebot3_navigation2')
    ...
    pbstream_file = LaunchConfiguration('pbstream_file',default=os.path.join(turtlebot3_navigation, 'map/test.pbstream'))
