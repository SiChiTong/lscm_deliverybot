...
def generate_launch_description():
    return launch.LaunchDescription([
        ...
        IncludeLaunchDescription(str(get_package_share_path('door_contr') / 'launch/door.launch.py'),
                                 ), 
        launch_ros.actions.Node(name='simple_nav', package='simple_nav', executable='gui_door_sim')     
