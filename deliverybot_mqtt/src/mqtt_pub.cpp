...
public:
        ...
        : Node("mqtt_node")
    {
        ...
        status_pub_ = this->create_publisher<deliverybot_mqtt_interfaces::msg::Status>("robots/id_" + std::to_string(robot_id.as_int()) + "/status", 10);
        location_pub_ = this->create_publisher<deliverybot_mqtt_interfaces::msg::Location>("robots/id_" + std::to_string(robot_id.as_int()) + "/location", 10);
        config_pub_ = this->create_publisher<deliverybot_mqtt_interfaces::msg::Configuration>("robots/configuration", 10);
        ...
        auto config = deliverybot_mqtt_interfaces::msg::Configuration();
        auto location_entry = deliverybot_mqtt_interfaces::msg::LocationEntry();
...
private:
    void location_callback(const geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr msg) const
    {
        ...
        // Location publisher
        auto location = deliverybot_mqtt_interfaces::msg::Location();
    ...
    void timer_callback()
    {
        ...
        // Status publisher
        auto status = deliverybot_mqtt_interfaces::msg::Status();
    ...
    rclcpp::Publisher<deliverybot_mqtt_interfaces::msg::Status>::SharedPtr status_pub_;
    rclcpp::Publisher<deliverybot_mqtt_interfaces::msg::Location>::SharedPtr location_pub_;
    rclcpp::Publisher<deliverybot_mqtt_interfaces::msg::Configuration>::SharedPtr config_pub_;
};
